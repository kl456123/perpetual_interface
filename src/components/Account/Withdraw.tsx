...
export default function Withdraw(props: { switchMode: (mode: Mode) => void }) {
  ...
  const [amount, setAmount] = useState('0');
    ...
    const withdraw = async (amount: string)=>{
        ...
        const data = iface.encodeFunctionData("withdraw", [account, account, amount]);
  ...
  return (
    ...
    <VStack align="left">
        <HStack><Text>Fee</Text> <Spacer/> <Text>-</Text></HStack>
        <HStack><Text>Total</Text> <Spacer/> <Text>-</Text></HStack>
        <HStack><Text>Wallet<Tag>USDC</Tag></Text> <Spacer/> <Text>0.00000</Text></HStack>
